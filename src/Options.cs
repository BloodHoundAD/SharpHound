...
namespace Sharphound
{
    public class Options
    {
        ...
        [Option('c', "collectionmethods", Default = new[] { "Default" },
            HelpText =
                "Collection Methods: Group, LocalGroup, LocalAdmin, RDP, DCOM, PSRemote, Session, Trusts, ACL, Container, ComputerOnly, GPOLocalGroup, LoggedOn, ObjectProps, SPNTargets, UserRights, Default, DCOnly, CARegistry, DCRegistry, CertServices, WebClientService, LdapServices, SmbInfo, NTLMRegistry, AzureVM, All")]
        ...
        internal bool ResolveCollectionMethods(ILogger logger, out CollectionMethod resolved, out bool dconly)
        {
            ...
            foreach (var baseMethod in arr)
            {
                ...
                resolved |= option switch
                {
                    ...
                    CollectionMethodOptions.AzureVM => CollectionMethod.AzureVM,
